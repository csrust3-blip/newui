...
function LegendUI.AddPageTab(_, navTab, name)
    local Btn = Instance.new("TextButton")
...
function LegendUI._buildBox(parent, title)
    ...
    if title then
        ...
        HeaderLabel.Position = UDim2.fromOffset(0, 0)
    ...
    function Box:AddToggle(text, default, accentColor, callback)
        ...
        ColorArea:SetAttribute("NoWindowDrag", true)
        ...
        WhiteGradient:SetAttribute("NoWindowDrag", true)
        ...
        BlackGradient:SetAttribute("NoWindowDrag", true)
        ...
        ColorCursor:SetAttribute("NoWindowDrag", true)
        ...
        HueSlider:SetAttribute("NoWindowDrag", true)
        ...
        HueCursor:SetAttribute("NoWindowDrag", true)
        ...
        Cancel.ZIndex = 101
        Cancel:SetAttribute("NoWindowDrag", true)
        ...
        Apply.ZIndex = 101
        Apply:SetAttribute("NoWindowDrag", true)
        ...
        PickerCatcher.MouseButton1Click:Connect(function()
            closePicker()
        end)
